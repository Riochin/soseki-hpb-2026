    ...
    <section className="px-4 py-12 md:px-8 lg:px-16">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <div className="rounded-xl border border-zinc-700 bg-zinc-900 p-6 transition-colors hover:border-yellow-400/50">
          ...
          <a
            href="/games/typing-game.html"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-block w-full rounded-lg bg-yellow-400 py-2 text-center font-bold text-black transition-opacity hover:opacity-90"
          >
            PLAY NOW
          </a>
        </div>
