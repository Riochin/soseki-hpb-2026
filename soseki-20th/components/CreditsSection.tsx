const CREDITS = [
  { role: '原案・サイト開発', names: ['マルハット'] },
  {
    ...
    names: ['肩幅', 'からてん', '小滝えき', 'むぷん', 'SBG', 'マルハット', 'K'],
  },
  { role: '名言提供', names: ['ぬま', 'らりほー', 'トッテン', '肩幅', 'しゆう', 'マルハット'] },
  {
    role: 'ミニゲーム協力',
    names: ['ANNA', 'ぬま', 'しゆう', 'トッテン', 'らりほー', '肩幅', 'マルハット'],
  },
  {
    role: 'ガチャアイテム提供',
    names: ['しゆう', '帝王', 'ぬま', 'SBG', 'トッテン', 'ANNA', 'K', '肩幅', 'マルハット'],
  },
  { role: 'UR確定演出提供', names: ['オーガスト'] },
