            ...
            >
              ...
              <div className="min-w-full px-10">
                <button
                  ...
                  className="flex min-h-[140px] w-full flex-col items-center justify-center gap-3 border-2 border-dashed border-yellow-400/50 bg-transparent text-yellow-400 transition-colors hover:border-yellow-400 hover:bg-yellow-400/5"
                >
        ...
        >
          ...
          <div className="flex gap-3">
            <button
              type="submit"
              disabled={submitting}
              className="bg-yellow-400 px-6 py-2 font-bold text-black transition-opacity hover:opacity-90 disabled:opacity-50"
            >
              {submitting ? '送信中...' : '送信'}
            </button>
            <button
              ...
              className="border-2 border-zinc-600 px-6 py-2 text-gray-400 transition-colors hover:bg-[#1a120a]"
            >
              キャンセル
            </button>
          </div>
