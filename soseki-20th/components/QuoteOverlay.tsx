...
const quotes = [
  { text: '智に働けば角が立つ。情に棹させば流される。意地を通せば窮屈だ。とかくに人の世は住みにくい。', source: '草枕' },
  { text: '自分が正しいと思ったら、どんな反対があっても、自分を貫け。', source: 'こころ' },
  { text: '人間は自分の一生を貫く仕事を持たなければならない。', source: '道草' },
  { text: '恋は罪悪ですよ、と彼は云った。', source: 'こころ' },
  { text: '義務は大事だ。しかし義務は一種の牢獄だよ。', source: '行人' },
  { text: '月が綺麗ですね。', source: '（伝説）' },
  { text: '誠実さのない天才よりも、才能のない誠実さの方が世の中の役に立つ。', source: '吾輩は猫である' },
]
